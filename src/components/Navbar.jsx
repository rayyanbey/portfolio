    ...
    return (
        <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
            <div className='max-w-[1300px] mx-auto flex justify-between text-gray-200 text-xl items-center px-12 h-20'>
                <a href="#" className="text-2xl font-bold">Muhammad Rayyan Asghar</a>
                <ul className='hidden md:flex gap-12 cursor-pointer'>
                    ...
                    <li><Link to="contact" smooth={true} offset={50} duration={500}>AboutMe</Link></li>
                </ul>
                ...
                <motion.div
                    ...
                    className='fixed left-0 top-0 w-full h-screen bg-black z-40'
                >
                    <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                        ...
                        <li><Link to="contact" onClick={closeNav} smooth={true} offset={50} duration={500}>AboutMe</Link></li>
                    </ul>
                </motion.div>
            </div>
        </div>
